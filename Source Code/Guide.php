...
<?PHP
	if(isset($_SESSION['Time']) && $_SESSION['ROLE'] == 'Guide'){
		   ...
		   <label for="tab4">
			   ...
			   <!--<div id="tab-content3" class="tab-content">
				  <h3>Register Tour</h3>  
					<?php
						/*$conn = oci_connect("system", "123456", "//localhost/XE", "UTF8");
						$passportno = $_SESSION['PASSPORTNO'];
						$query = "SELECT * FROM package where company_id in (select company_id from guide where company_id = '$ppno') order by package_no";
						$parseRequest = oci_parse($conn, $query);
						oci_execute($parseRequest);
