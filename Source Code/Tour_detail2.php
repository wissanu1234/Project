<?PHP
	...
	if(isset($_POST['buypackage']))
	{
		...
		$query = "insert into current_tour values('$ppno','$id')";
		$parseRequest = oci_parse($conn, $query);
		oci_execute($parseRequest);
...
<html>
	...
	<body>
		...
		<div class="poomlangkwa"><form method = 'post'>
			<input style="margin-left:150px; border-radius:12px;"name='buypackage' type='submit' value = 'Buy Package'></form>
		</div>
	</body>
</html>